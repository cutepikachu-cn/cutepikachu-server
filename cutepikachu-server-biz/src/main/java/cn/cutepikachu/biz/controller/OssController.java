...
public class OssController {
    ...
    public ResponseEntity<FileInfoVO> upload(@RequestParam MultipartFile file) throws IOException {
        ...
        minioService.upload(file.getBytes(), FileBizTag.USER_AVATAR, fileInfo.getPath(), fileInfo.getType());
