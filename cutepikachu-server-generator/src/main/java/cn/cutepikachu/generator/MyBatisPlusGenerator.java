...
public class MyBatisPlusGenerator {
    ...
    private static final String OUTPUT_DIR =
            System.getProperty("user.dir") + "/cutepikachu-server-generator/src/main/java";
    ...
    public static void main(String[] args) {
        String url =
                String.format(
                        "jdbc:mysql://localhost:3306/%s?remarks=true&useInformationSchema=true&tinyInt1isBit=true",
                        DATABASE);
        ...
        FastAutoGenerator
                ...
                .injectionConfig(injectionConfigBuilder -> {
                    ...
                    // 自定义输出文件
                    injectionConfigBuilder.beforeOutputFile(
                            (tableInfo, objectMap) -> {
